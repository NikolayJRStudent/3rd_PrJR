...
<head>
    ...
    <style>
       html {
           background-image: url(https://th.bing.com/th/id/OIG.iUmhJrYelPRCOSv_Dju_?pid=ImgGn);
...
<div class="main">
      ...
      <div class="centered">
              Вы спрашиваете у эльфа о том, как найти выход из леса.
              Эльф показывает вам путь, который ведет к главному выходу.
              Вы покидаете лес, но чувствуете, что что-то внутри вас все равно осталось привязанным к этому месту.
              Вы решаете вернуться в хижину и продолжить исследование магии леса в будущем.
      </div>
     <div>
